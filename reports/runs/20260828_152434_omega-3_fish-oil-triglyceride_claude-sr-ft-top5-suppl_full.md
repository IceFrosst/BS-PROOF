...
|---|---:|---:|---:|---:|---|
| S3 | 128 | 2 | 119 | 0 | exit 1: max_turns (x2) |
| S4 | 130 | 0 | 121 | 0 | — |
| S5 | 129 | 1 | 118 | 0 | exit 1: max_turns (x1) |
| S7 | 130 | 0 | 118 | 0 | — |
| S8 | 130 | 0 | 121 | 0 | — |
...
- S6B: 13 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
- S3: 17 attempts for 130 studies -- impossible, every study needs at least one attempt
- S4: 9 attempts for 130 studies -- impossible, every study needs at least one attempt
- S5: 17 attempts for 130 studies -- impossible, every study needs at least one attempt
- S7: 15 attempts for 130 studies -- impossible, every study needs at least one attempt
- S8: 9 attempts for 130 studies -- impossible, every study needs at least one attempt
