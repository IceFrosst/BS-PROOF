...
Generated: **2026-08-12 06:32 UTC**
...
- Model calls: **14** (cache hits 878, failures 7)
- Input tokens: **1,534,997** (fresh 16 · cache-write 2,585 · cache-read 1,532,396)
- Output tokens: **5,317**
- **Spent on this run: $0.00** — subscription, not metered.
- **API-equivalent cost: $0.564** — what the same work would cost billed per token.
- Per study: **0.1 calls**, **$0.0038** API-equivalent across 149 scored studies.

| Agent | Tier | Model | Calls | Cache hits | Fail | In | Out | API-equiv |
|---|---|---|--:|--:|--:|--:|--:|--:|
| S3 | B | `claude-sonnet-5` | 4 | 147 | 3 | 747,707 | 784 | $0.236 |
| S4 | B | `claude-sonnet-5` | 0 | 149 | 0 | 0 | 0 | $0.000 |
| S5 | B | `claude-sonnet-5` | 7 | 145 | 4 | 772,433 | 2,199 | $0.268 |
| S6B | C | `claude-sonnet-5` | 2 | 140 | 0 | 8,681 | 1,847 | $0.048 |
| S7 | B | `claude-sonnet-5` | 1 | 148 | 0 | 6,176 | 487 | $0.013 |
...
|---|---:|---:|---:|---:|---|
| S3 | 148 | 1 | 147 | 0 | exit 1: Prompt is too long (x1) |
| S4 | 149 | 0 | 149 | 0 | — |
| S5 | 148 | 1 | 145 | 0 | exit 1: Prompt is too long (x1) |
| S7 | 149 | 0 | 148 | 0 | — |
| S8 | 149 | 0 | 149 | 0 | — |
...
- S6B: 2 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
- S3: 4 attempts for 149 studies -- impossible, every study needs at least one attempt
- S4: 0 attempts for 149 studies -- impossible, every study needs at least one attempt
- S5: 7 attempts for 149 studies -- impossible, every study needs at least one attempt
- S7: 1 attempts for 149 studies -- impossible, every study needs at least one attempt
...
|---|---:|---|---|---|---|---|---:|
| muscle_power | 45 | unclear | +0.07 @ 100% | 0.80 (pooled +0.10 @ 60%) | not tested | 96% | 30 |
...
| exercise_endurance | 27 | probably does not work | -0.25 @ 100% | 0.80 (pooled -0.30 @ 66%) | not tested | 67% | 10 |
...
### exercise_endurance — signed -16

| Study | points | w (quality) | s (direction) | rank | form |
|---|--:|--:|--:|--:|---|
| `doi:103390nu12010193` | -5.96 | 0.4341 | -0.35 | 4 | exact |
| `doi:101111sms14629` | -5.81 | 0.4234 | -0.35 | 4 | exact |
| `doi:101016jjsams201510005` | -2.68 | 0.195 | -0.35 | 4 | unspecified |
| `doi:101113ep087886` | +2.25 | 0.0573 | 1.0 | 4 | unspecified |
| `doi:103390nu9121359` | -1.58 | 0.1149 | -0.35 | 4 | different |
| `doi:101007s0072600603996` | -1.31 | 0.0957 | -0.35 | 4 | exact |
| `doi:103390nu14061140` | -1.24 | 0.0903 | -0.35 | 4 | unspecified |
| `doi:101123ijspp20240310` | +1.09 | 0.0925 | 0.3 | 4 | exact |
| `doi:101123ijsnem20160129` | -0.93 | 0.0677 | -0.35 | 4 | exact |
