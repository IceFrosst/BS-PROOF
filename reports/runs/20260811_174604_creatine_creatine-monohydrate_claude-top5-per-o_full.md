...
|---|---:|---:|---:|---:|---|
| S3 | 94 | 55 | 0 | 10 | exit 1: You've hit your session limit · resets 1:10am (Europe/Vilnius) (x54); exit 1: Prompt is too long (x1) |
| S4 | 96 | 53 | 0 | 20 | exit 1: You've hit your session limit · resets 1:10am (Europe/Vilnius) (x53) |
| S5 | 94 | 55 | 0 | 20 | exit 1: You've hit your session limit · resets 1:10am (Europe/Vilnius) (x53); exit 1: max_turns (x1) |
| S7 | 93 | 56 | 0 | 20 | exit 1: You've hit your session limit · resets 1:10am (Europe/Vilnius) (x53); exit 1: max_turns (x3) |
| S8 | 96 | 53 | 0 | 0 | exit 1: You've hit your session limit · resets 1:10am (Europe/Vilnius) (x53) |
...
- S6B: 91 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
