...
Generated: **2026-08-25 17:35 UTC**
...
- Model calls: **64** (cache hits 903, failures 10)
- Input tokens: **449,010** (fresh 116 · cache-write 226,157 · cache-read 222,737)
- Output tokens: **100,949**
- **Spent on this run: $0.00** — subscription, not metered.
- **API-equivalent cost: $3.125** — what the same work would cost billed per token.
- Per study: **0.4 calls**, **$0.0202** API-equivalent across 155 scored studies.

| Agent | Tier | Model | Calls | Cache hits | Fail | In | Out | API-equiv |
|---|---|---|--:|--:|--:|--:|--:|--:|
| S2 | B | `claude-sonnet-5` | 58 | 0 | 4 | 449,010 | 100,949 | $3.125 |
| S3 | B | `claude-sonnet-5` | 3 | 155 | 3 | 0 | 0 | $0.000 |
| S4 | B | `claude-sonnet-5` | 0 | 155 | 0 | 0 | 0 | $0.000 |
| S5 | B | `claude-sonnet-5` | 3 | 155 | 3 | 0 | 0 | $0.000 |
| S6B | C | `claude-sonnet-5` | 0 | 128 | 0 | 0 | 0 | $0.000 |
...
- S2: 58 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
...
- S4: 0 attempts for 155 studies -- impossible, every study needs at least one attempt
- S5: 3 attempts for 155 studies -- impossible, every study needs at least one attempt
- S7: 0 attempts for 155 studies -- impossible, every study needs at least one attempt
- S8: 0 attempts for 155 studies -- impossible, every study needs at least one attempt
...
|---|---:|---|---|---|---|---|---:|
| muscle_strength | 38 | probably does not work | +0.04 @ 100% | 0.80 (pooled +0.02 @ 87%) | not tested | 82% | 12 |
| muscle_power | 34 | probably does not work | +0.24 @ 100% | 0.80 (pooled +0.08 @ 73%) | not tested | 69% | 12 |
| lean_body_mass | 30 | probably does not work | +0.09 @ 100% | 0.80 (pooled +0.07 @ 93%) | not tested | 64% | 6 |
| exercise_endurance | 21 | works, but not tested for your product | +0.73 @ 100% | 0.80 (pooled +0.70 @ 92%) | not tested | 36% | 3 |
