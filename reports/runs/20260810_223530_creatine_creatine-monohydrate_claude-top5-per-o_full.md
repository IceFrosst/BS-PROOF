...
FAILURES: projected c exceeds sample c
```
...
|---|---:|---:|---:|---:|---|
| S3 | 142 | 2 | 142 | 0 | exit 1: max_turns (x1); exit 1: Prompt is too long (x1) |
| S4 | 144 | 0 | 144 | 0 | — |
| S5 | 144 | 0 | 144 | 0 | — |
| S7 | 144 | 0 | 144 | 0 | — |
| S8 | 144 | 0 | 144 | 0 | — |
...
- S3: 6 attempts for 144 studies -- impossible, every study needs at least one attempt
