...
|---|---:|---:|---:|---:|---|
| S3 | 147 | 2 | 94 | 0 | exit 1: max_turns (x1); exit 1: Prompt is too long (x1) |
| S4 | 149 | 0 | 96 | 0 | — |
| S5 | 145 | 4 | 94 | 0 | exit 1: max_turns (x3); exit 1: Prompt is too long (x1) |
| S7 | 148 | 1 | 93 | 0 | exit 1: max_turns (x1) |
| S8 | 149 | 0 | 96 | 0 | — |
...
- S6B: 72 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
- S3: 61 attempts for 149 studies -- impossible, every study needs at least one attempt
- S4: 67 attempts for 149 studies -- impossible, every study needs at least one attempt
- S5: 65 attempts for 149 studies -- impossible, every study needs at least one attempt
- S7: 70 attempts for 149 studies -- impossible, every study needs at least one attempt
- S8: 53 attempts for 149 studies -- impossible, every study needs at least one attempt
