...
|---|---:|---:|---:|---:|---|
| S3 | 148 | 1 | 0 | 10 | exit 1: Prompt is too long (x1) |
| S4 | 143 | 6 | 0 | 28 | exit 1: max_turns (x6) |
| S5 | 143 | 6 | 0 | 44 | exit 1: max_turns (x5); exit 1: Prompt is too long (x1) |
...
- S6B: 139 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
