...
Generated: **2026-08-19 07:14 UTC**
...
- Model calls: **10** (cache hits 1043, failures 9)
- Input tokens: **66,652** (fresh 8 · cache-write 0 · cache-read 66,644)
- Output tokens: **8,779**
- **Spent on this run: $0.00** — subscription, not metered.
- **API-equivalent cost: $0.186** — what the same work would cost billed per token.
- Per study: **0.1 calls**, **$0.0011** API-equivalent across 176 scored studies.

| Agent | Tier | Model | Calls | Cache hits | Fail | In | Out | API-equiv |
|---|---|---|--:|--:|--:|--:|--:|--:|
| S3 | B | `claude-sonnet-5` | 3 | 175 | 3 | 0 | 0 | $0.000 |
| S4 | B | `claude-sonnet-5` | 1 | 175 | 0 | 4,747 | 575 | $0.012 |
| S5 | B | `claude-sonnet-5` | 6 | 174 | 6 | 61,905 | 8,204 | $0.174 |
| S6B | C | `claude-sonnet-5` | 0 | 167 | 0 | 0 | 0 | $0.000 |
| S7 | B | `claude-sonnet-5` | 0 | 176 | 0 | 0 | 0 | $0.000 |
| S8 | A | `claude-haiku-4-5-20251001` | 0 | 176 | 0 | 0 | 0 | $0.000 |
...
|---|---:|---:|---:|---:|---|
| S3 | 175 | 1 | 175 | 0 | exit 1: Prompt is too long (x1) |
| S4 | 176 | 0 | 175 | 0 | — |
| S5 | 174 | 2 | 174 | 0 | exit 1: max_turns (x1); exit 1: Prompt is too long (x1) |
| S7 | 176 | 0 | 176 | 0 | — |
| S8 | 176 | 0 | 176 | 0 | — |
...
- S3: 3 attempts for 176 studies -- impossible, every study needs at least one attempt
- S4: 1 attempts for 176 studies -- impossible, every study needs at least one attempt
- S5: 6 attempts for 176 studies -- impossible, every study needs at least one attempt
- S7: 0 attempts for 176 studies -- impossible, every study needs at least one attempt
- S8: 0 attempts for 176 studies -- impossible, every study needs at least one attempt
