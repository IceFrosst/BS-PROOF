...
|---|---:|---:|---:|---:|---|
| S1 | 152 | 3 | 46 | 190 | exit 1: max_turns (x3) |
| S3 | 151 | 4 | 52 | 150 | exit 1: max_turns (x3); exit 1: Prompt is too long (x1) |
| S4 | 153 | 2 | 51 | 151 | exit 1: max_turns (x2) |
| S5 | 154 | 1 | 51 | 154 | exit 1: Prompt is too long (x1) |
| S7 | 154 | 1 | 53 | 133 | exit 1: max_turns (x1) |
| S8 | 155 | 0 | 45 | 142 | — |
...
- S5T: 15 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
- S6B: 134 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
