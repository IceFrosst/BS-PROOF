...
Generated: **2026-08-24 17:26 UTC**
...
|---|---:|---|---|---|---|---|---:|
| muscle_power | 67 | probably works | -0.01 @ 100% | 0.80 (pooled -0.02 @ 55%) | +0.15 @ 29% | 95% | 25 |
| lean_body_mass | 50 | unclear | +0.03 @ 100% | 0.80 (pooled -0.04 @ 80%) | -0.08 @ 36% | 84% | 11 |
| muscle_strength | 38 | probably does not work | -0.22 @ 100% | 0.80 (pooled -0.26 @ 72%) | -0.26 @ 34% | 88% | 16 |
| energy_levels | 28 | works, but weakly evidenced | +0.36 @ 100% | 0.80 (pooled +0.30 @ 60%) | +0.30 @ 3% | 38% | 3 |
...
|---|--:|--:|--:|--:|---|
| `doi:103390nu12102961` | +3.35 | 0.1626 | 1.0 | 4 | unspecified |
| `doi:101186s12970021004077` | +3.30 | 0.1602 | 1.0 | 4 | unspecified |
| `doi:103390nu16152437` | -3.13 | 0.4341 | -0.35 | 4 | unspecified |
| `doi:101111sms14629` | +2.30 | 0.3727 | 0.3 | 4 | exact |
| `doi:103390nu15163567` | -2.22 | 0.3089 | -0.35 | 4 | exact |
| `doi:103390nu17243831` | +2.12 | 0.3438 | 0.3 | 4 | exact |
| `doi:101123ijsnem20140146` | +1.73 | 0.126 | 0.6666666666666665 | 4 | exact |
| `doi:103390nu14061140` | -1.56 | 0.2167 | -0.35 | 4 | exact |
| `doi:101519jsc0000000000001223` | -1.25 | 0.1732 | -0.35 | 4 | exact |
| `doi:101016jjsams201510005` | +1.20 | 0.195 | 0.3 | 4 | unspecified |
| `doi:101186s1297001701622` | -1.17 | 0.1626 | -0.35 | 4 | unspecified |
| `doi:101016jnut201303003` | +1.14 | 0.1845 | 0.3 | 4 | unspecified |
| `doi:101136bjsm2005022558` | -1.12 | 0.1556 | -0.35 | 4 | unspecified |
| `doi:103390nu16060766` | -1.06 | 0.147 | -0.35 | 4 | different |
...
| Study | points | w (quality) | s (direction) | rank | form |
|---|--:|--:|--:|--:|---|
| `doi:103390nu12010193` | -7.46 | 0.7236 | -0.35 | 4 | exact |
| `doi:101249mss0000000000003202` | +5.30 | 0.6 | 0.3 | 4 | exact |
| `doi:101007bf02982622` | +4.78 | 0.3896 | 0.4166666666666667 | 4 | unspecified |
| `doi:101007s1260300901248` | -4.52 | 0.4383 | -0.35 | 4 | exact |
| `doi:1033549physiolres935323` | +1.41 | 0.1602 | 0.3 | 4 | exact |
| `doi:1010801550278320232193556` | +1.06 | 0.12 | 0.3 | 4 | exact |
| `registry:isrctn83081058` | +0.91 | 0.1025 | 0.3 | 4 | exact |
| `registry:nct01472393` | +0.86 | 0.0978 | 0.3 | 4 | unspecified |
| `doi:101007s004210031031z` | +0.60 | 0.0677 | 0.3 | 4 | exact |
| `doi:103390nu10111640` | -0.52 | 0.05 | -0.35 | 4 | unspecified |
| `registry:nct04048616` | -0.23 | 0.022 | -0.35 | 4 | unspecified |
| **sum of all 11** | **+2.19** | | | | |
