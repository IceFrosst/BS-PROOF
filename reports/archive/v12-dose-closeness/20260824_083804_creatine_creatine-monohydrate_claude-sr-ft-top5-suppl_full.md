...
- Model calls: **51** (cache hits 1074, failures 51)
...
- Per study: **0.3 calls**, **$0.0000** API-equivalent across 155 scored studies.
...
| S5T | A | `claude-haiku-4-5-20251001` | 45 | 0 | 45 | 0 | 0 | $0.000 |
...
|---|---:|---:|---:|---:|---|
| S1 | 155 | 0 | 155 | 0 | — |
| S3 | 154 | 1 | 154 | 0 | exit 1: Prompt is too long (x1) |
| S4 | 155 | 0 | 155 | 0 | — |
| S5 | 154 | 1 | 154 | 0 | exit 1: Prompt is too long (x1) |
| S7 | 155 | 0 | 155 | 0 | — |
| S8 | 155 | 0 | 155 | 0 | — |
...
- S5T: 45 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
