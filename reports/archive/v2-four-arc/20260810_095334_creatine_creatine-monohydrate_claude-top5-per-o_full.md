...
|---|---:|---:|---:|---:|---|
| S3 | 143 | 0 | 0 | 3 | — |
| S4 | 138 | 5 | 0 | 40 | exit 1: max_turns (x5) |
| S5 | 143 | 0 | 0 | 10 | — |
| S7 | 140 | 3 | 0 | 34 | exit 1: max_turns (x3) |
| S8 | 143 | 0 | 0 | 0 | — |
...
- S6B: 132 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
