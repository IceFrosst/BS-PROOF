...
|---|---:|---:|---:|---:|---|
| S3 | 147 | 2 | 0 | 9 | exit 1: max_turns (x1); exit 1: Prompt is too long (x1) |
| S4 | 148 | 1 | 0 | 35 | exit 1: max_turns (x1) |
| S5 | 149 | 0 | 0 | 3 | — |
| S7 | 146 | 3 | 0 | 38 | exit 1: max_turns (x3) |
| S8 | 149 | 0 | 0 | 1 | — |
...
- S6B: 136 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
