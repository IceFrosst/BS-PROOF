...
|---|---:|---:|---:|---:|---|
| S3 | 145 | 4 | 0 | 20 | exit 1: max_turns (x3); exit 1: Prompt is too long (x1) |
| S4 | 147 | 2 | 0 | 48 | exit 1: max_turns (x2) |
| S5 | 147 | 2 | 0 | 25 | exit 1: max_turns (x1); exit 1: Prompt is too long (x1) |
| S7 | 148 | 1 | 0 | 30 | exit 1: max_turns (x1) |
| S8 | 149 | 0 | 0 | 0 | — |
...
- S6B: 144 attempts in the cost table but no row in the success table -- its failures are invisible to anyone reading success rates
