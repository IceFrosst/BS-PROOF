...
Generated: **2026-08-25 17:53 UTC**
...
- Model calls: **6** (cache hits 957, failures 6)
...
- Per study: **0.0 calls**, **$0.0000** API-equivalent across 155 scored studies.

| Agent | Tier | Model | Calls | Cache hits | Fail | In | Out | API-equiv |
|---|---|---|--:|--:|--:|--:|--:|--:|
| S2 | B | `claude-sonnet-5` | 0 | 54 | 0 | 0 | 0 | $0.000 |
...
|---|---:|---|---|---|---|---|---:|
| muscle_strength | 38 | probably does not work | +0.04 @ 100% | 0.80 (pooled +0.02 @ 87%) | +0.00 @ 47% | 82% | 12 |
| muscle_power | 35 | probably does not work | +0.24 @ 100% | 0.80 (pooled +0.08 @ 73%) | +0.37 @ 22% | 69% | 12 |
| lean_body_mass | 30 | probably does not work | +0.09 @ 100% | 0.80 (pooled +0.07 @ 93%) | +0.00 @ 11% | 64% | 6 |
| exercise_endurance | 30 | works, but weakly evidenced | +0.73 @ 100% | 0.80 (pooled +0.70 @ 92%) | +0.47 @ 51% | 36% | 3 |
